...
class ViewBlogFragment : BaseBlogFragment(){
    ...
    private fun checkIsAuthorOfBlogPost() {
        ...
        viewModel.setStateEvent(BlogStateEvent.CheckAuthorOfBlogPost()) // reset
    }
    ...
    fun setBlogProperties(blogPost: BlogPost) {
        ...
        blog_update_date.setText(com.codingwithmitch.openapi.util.DateUtils.convertLongToStringDate(
